...
** High Availability through fail-over: removes single point of failure
** High Availability through load-balancing: timely response to client, even with high-volume requests
